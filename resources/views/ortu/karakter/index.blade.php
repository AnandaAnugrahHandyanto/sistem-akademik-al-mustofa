...
@section('content')
<h4 class="fw-semibold mb-3" style="font-family:'Poppins',sans-serif;">Karakter Anak</h4>
<div class="card"><div class="card-body p-0"><div class="table-responsive">
<table class="table table-hover align-middle mb-0">
<thead><tr><th class="ps-3 text-nowrap" style="min-width:110px">Aspek</th><th class="text-nowrap" style="min-width:70px">Nilai</th><th class="text-nowrap" style="min-width:110px">Tanggal</th></tr></thead>
<tbody>
@forelse($data as $r)
