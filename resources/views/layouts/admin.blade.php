...
<title>@yield('title','Admin - SDIT Al-Mustofa')</title>
...
<a href="{{ route('admin.laporan.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.laporan.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-file-earmark-text"></i> Laporan</a>
</nav>
</aside>
...
<div class="d-flex align-items-center"><button class="btn btn-outline-secondary btn-sm me-2 d-md-none" onclick="openSidebar()"><i class="bi bi-list"></i></button><span class="fw-semibold">Admin</span></div>
<div class="dropdown">
