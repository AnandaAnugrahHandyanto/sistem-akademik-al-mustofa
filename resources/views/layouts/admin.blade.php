...
<a href="{{ route('admin.kelas.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.kelas.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-door-open"></i> Kelas</a>
<a href="{{ route('admin.mapel.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('admin.mapel.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-journal-bookmark"></i> Mata Pelajaran</a>
