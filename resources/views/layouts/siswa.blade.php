...
<a href="{{ route('siswa.nilai.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('siswa.nilai.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-123"></i> Nilai Saya</a>
<a href="{{ route('siswa.hafalan.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('siswa.hafalan.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-book"></i> Hafalan</a>
