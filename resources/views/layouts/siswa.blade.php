...
<title>@yield('title','Siswa - SDIT Al-Mustofa')</title>
...
<div class="d-flex align-items-center"><button class="btn btn-outline-secondary btn-sm me-2 d-md-none" onclick="openSidebar()"><i class="bi bi-list"></i></button><span class="fw-semibold">Siswa</span></div>
<div class="dropdown">
