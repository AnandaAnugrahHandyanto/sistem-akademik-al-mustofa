<!doctype html>
<html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>@yield('title','Al-Mustofa')</title>
...
<body class="bg-slate-50 min-h-screen">@yield('content')</body></html>
