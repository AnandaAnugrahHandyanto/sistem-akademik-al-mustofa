...
<nav class="d-md-none bg-white border-bottom p-2 d-flex align-items-center"><button class="btn btn-outline-secondary btn-sm" onclick="openSidebar()"><i class="bi bi-list"></i></button><span class="ms-2 fw-semibold">Orang Tua</span></nav>
