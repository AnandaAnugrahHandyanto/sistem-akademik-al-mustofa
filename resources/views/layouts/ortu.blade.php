...
<title>@yield('title','Orang Tua - SDIT Al-Mustofa')</title>
...
.sidebar{width:260px;height:100vh;background:#ca8a04;color:#ffffff;position:sticky;top:0;flex-shrink:0;display:flex;flex-direction:column;}
...
<small style="opacity:.8;">Orang Tua</small>
</div>
<nav class="nav flex-column gap-1 sidebar-menu" id="sidebar-menu">
<a href="{{ route('ortu.nilai.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('ortu.nilai.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-clipboard-data"></i> Nilai Anak</a>
<a href="{{ route('ortu.hafalan.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('ortu.hafalan.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-book-half"></i> Hafalan</a>
<a href="{{ route('ortu.karakter.index') }}" class="nav-link d-flex align-items-center gap-2 px-3 py-2 rounded {{ request()->routeIs('ortu.karakter.*') ? 'active' : '' }}" onclick="closeSidebarIfMobile()"><i class="bi bi-heart"></i> Karakter</a>
</nav>
</aside>
...
<div class="d-flex align-items-center"><button class="btn btn-outline-secondary btn-sm me-2 d-md-none" onclick="openSidebar()"><i class="bi bi-list"></i></button><span class="fw-semibold">Orang Tua</span></div>
<div class="dropdown">
