...
<a class="nav-link" href="{{ route('ortu.nilai.index') }}">Nilai Anak</a><a class="nav-link" href="{{ route('ortu.hafalan.index') }}">Hafalan</a><a class="nav-link" href="{{ route('ortu.karakter.index') }}">Karakter</a>
</div>
