...
<thead><tr><th class="ps-3 text-nowrap" style="min-width:150px">Nama</th><th class="text-nowrap" style="min-width:150px">Guru Pengampu</th><th class="text-end pe-3 text-nowrap" style="min-width:110px">Aksi</th></tr></thead>
<tbody>
@forelse($data as $r)
