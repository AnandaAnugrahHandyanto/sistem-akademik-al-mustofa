...
<thead><tr><th class="ps-3 text-nowrap" style="min-width:140px">Username</th><th class="text-nowrap" style="min-width:180px">Name</th><th class="text-nowrap" style="min-width:80px">Role</th><th class="text-nowrap" style="min-width:180px">Email</th><th class="text-end pe-3 text-nowrap" style="min-width:110px">Aksi</th></tr></thead>
<tbody>
@forelse($data as $r)
